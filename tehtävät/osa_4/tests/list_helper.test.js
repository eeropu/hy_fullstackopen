...
describe('total likes', () => {
  ...
  test('When list has no blogs is 0', () => {
    const result = listHelper.totalLikes([])
    expect(result).toBe(0)
  })

  test('When list has many blogs is the sum of blogs\' likes', () => {
...
describe('Favorite blog', () => {
  ...
  test('When list has many blogs is the one with most likes', () => {
...
describe('mostBlogs', () => {
  test('returns the right author and amount of blogs', () => {
...
describe('mostLikes', () => {
  test('returns the right author and amount of likes', () => {
